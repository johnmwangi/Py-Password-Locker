...
class TestCredentials(unittest.TestCase):
    ...
    '''
    def setUp(self):
        self.new_credential = Credentials("John","Mwangi","locker")
    ...
    def test__init__(self):
         ...
         self.assertEqual(self.new_credential.social_media,'facebook')    #     self.assertEqual(self.new_credential.password,'account')
